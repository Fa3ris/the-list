              ...
              items: [
                {
                  base: "/game/rpg/japan",
                  text: "Japan",
                  items: [{ text: "Pokemon", link: "/pokemon" }],
                },
              ],
            },
          ],
      ...
      "/book": [
        {
          base: "/book",
          text: "Book",
          items: [{ text: "Foo", link: "/foo" }],
        },
      ],
    });
  });

  it("read file to set the title", () => {
    vol.reset();
    vol.fromNestedJSON({
      "/docs": {
        book: {
          "the-fault-in-our-stars.md": `---
...
`,
    ...
    expect(toSideBarNav(walkDir("/docs"), "/docs")).toStrictEqual({
      "/book": [
        {
          base: "/book",
          items: [
